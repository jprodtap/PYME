...
public class Launch_AutogestionServicios extends BaseTestNG {
...
// =======================================================================================================================
	...
	PageAutogestionServicioMiddle pageAutogestionServiciosMiddle = null;
...
// -----------------------------------------------------------------------------------------------------------------------
		...
		if (msgError == null) {
			...
			this.pageAutogestionServicios = new PageAutogestionServicios(this.pageLogin);

			if (msgError == null) {
				this.pageAutogestionServicios.contratarEliminarServicios();

				List<HashMap<String, String>> data = this.pageAutogestionServicios.getResults();
				String date = this.pageAutogestionServicios.getTxDate();
...
//				PageUsuariosEmpresa.datosMidellToke(datoTok);
				...
				if (date != null) {
					Reporter.reportEvent(Reporter.MIC_FAIL,
							"No se aprobo ninguna transacción, por lo tanto no hay hora de transacción.");
				}

				if (msgErrorMid == null) {

					this.pageAutogestionServiciosMiddle = new PageAutogestionServicioMiddle(this.pageLogin);
					this.pageAutogestionServiciosMiddle.ConsultaNovedadesMiddle(date, data);
