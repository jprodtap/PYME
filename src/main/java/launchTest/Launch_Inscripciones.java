...
// =======================================================================================================================
	...
	PageInscripcionesCuenta pageInscripcionCuenta = null;
...
//		Evidence.siTomarla(Evidence.FORMATO_EXCEL); // TOMAR EVIDENCIAS POR ROW Y DEJA LO �LTIMO EN EL FORMATO INDICADO
		...
		SettingsRun.DEFAULT_HEADER = 4; // EL ARCHIVO DE DATOS EL HEADER ESTA EN LA FILA 4 : USARLO SI EL HEADER NO ESTA EN 4
// -----------------------------------------------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------------------------------------------------
		...
		if (msgError == null) {
			...
			if (msgError == null) {
				this.pageInscripcionCuenta = new PageInscripcionesCuenta(this.pageLogin);
				this.pageInscripcionCuenta.Inscripcion();
			} else {
